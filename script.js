	  ...
	  style: function(feature) {
           ...
           return d == 1 ? {color: '#00FF7F', opacity:0.7} :
                  ...
                  d == 3  ? {color: '#E31A1C', opacity:0.7} :    
					...
					d == 5  ? {color: '#BC1CE7', opacity:0.7} :
					 d == 6  ? {color: '#1CE7E4', opacity:0.7} :
...
var  nodo_148 = L.geoJSON(nodo_148, {
